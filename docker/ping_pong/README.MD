...
- [Usage Scenarios](#usage-scenarios)
  ...
  - [run http ping-pong server with custom server Name](#REDACTED)
  - [run http ping-pong server  with serverName = podName](#REDACTED)
  - [run http ping-pong server with MEMORY_USAGE](#REDACTED)
  - [emulate crash app](#emulate-crash-app)
  - [run http ping-pong server  with response delay 3 seconds and 10 workers](#REDACTED)
  - [run http ping-pong server  with additional response size in Kb](#REDACTED)
- Run
