...
## 0.27.1 (19.01.2026)
### Features
* [eks modules](../terraform/modules) are updated. This enables the creation of diverse tasks and the emulation of a production environment.
* [EKS lab . Karpenter Basics](../tasks/eks/labs/02/README.MD) is added.
* [EKS lab .Karpenter Basics RUS](../tasks/eks/labs/02/README_RUS.MD) is added.
* New useful [links](../docs/links.MD) for  exams are added.


## 0.26.1 (17.12.2025)
### Features
* [ica mock exam 01](../tasks/ica/mock/01) is added.
* [ica mock exam 01 solutions](../tasks/ica/mock/01/worker/files/solutions) is added.
* New useful [links](../docs/links.MD) for  exams are added.


## 0.25.1 (19.11.2025)
### Features
* [cks mock exam 04](../tasks/cks/mock/04) is added.
* [cks mock exam 04 solutions](../tasks/cks/mock/04/worker/files/solutions) is added.
* cks mock exam 04 [video solution](https://youtu.be/9W9KvSGq3nc) is added.
...
## 0.23.1 (12.08.2025)
### Features
* [AWS AI Practitioner example question](../tasks/aws_AI_practitioner/README.MD) is updated.
* [a service for synchronizing EKS(Kubernetes) services](../docker/k8s-svc-sync/README.MD) is added.
* Unit tests for [k8s-svc-sync](../docker/k8s-svc-sync/README.MD) are added.
...
* emulate slow response was added to [ping_pong](../docker/ping_pong/README.MD#REDACTED) service.
...
## 0.3.1 (15.09.2023)
### Features
* The ability to run the [k8s_self_management](..%2Fterraform%2Fmodules%2Fk8s_self_managment) module on [EC2 Graviton](https://docs.aws.amazon.com/whitepapers/latest/REDACTED/what-is-aws-graviton.html) is added
