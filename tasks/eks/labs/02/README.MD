...
- [Basic NodePool Configuration](#basic-nodepool-configuration)
  ...
  - [Creating NodePool and EC2NodeClass](#REDACTED)
  - [Verifying Automatic Node Creation](#REDACTED)
...
- [Node Lifecycle Management (Disruption)](#REDACTED)
- [Node Size Optimization (RightSizing)](#REDACTED)
  - [Automatic Optimal Size Selection](#REDACTED)
  - [Node Replacement on Requirement Changes](#REDACTED)
- [Node Configuration Updates (Drift)](#REDACTED)
  - [AMI Image Updates](#ami-image-updates)
  - [Automatic Migration to New Versions](#REDACTED)
- [Working with Multiple NodePools](#working-with-multiple-nodepools)
  - [Workload Isolation via Taints and Tolerations](#REDACTED)
...
# 20:26:31.128 STDOUT [worker] terraform: karpenter_node_iam_role_name = "REDACTED"
```
...
# karpenter_node_iam_role_name = "REDACTED"
```
...
metadata:
  name: job
spec:
  role: "REDACTED"  # Replace with yours
  amiSelectorTerms:
    - alias: "al2023@latest"
  subnetSelectorTerms:
    - tags:
